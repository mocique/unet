...
class dataProcess(object):
    ...
    def __init__(self, out_rows, out_cols, data_path, label_path,  test_path, npy_path, img_type="tif"):
        """
...
if __name__ == "__main__":
    ...
    print(train_img_path, train_label_path, test_path, npy_path)

    #aug = myAugmentation()
    # aug.Augmentation()
    # aug.splitMerge()
    # aug.splitTransform()
    mydata = dataProcess(512, 512, train_img_path, train_label_path, test_path, npy_path)
